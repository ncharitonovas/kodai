...
function custom_colors() {
   echo '<style type="text/css">
        #menu-dashboard, #menu-media, #menu-posts,  #menu-comments, #menu-tools, #menu-settings, #menu-users, #toplevel_page_Wordfence, #toplevel_page_activity_log_page, #toplevel_page_edit-post_type-acf-field-group {
